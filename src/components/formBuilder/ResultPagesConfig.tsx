  ...
  return (
    <Card className="glass-card">
      ...
      <CardContent className="space-y-6">
        ...
        {selectedPage === null ? (
          <div className="space-y-3">
            {/* Default landing page selector (top) */}
            <div className="border rounded-md p-3 bg-muted/30 space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Choose what visitors see first at <span className="font-mono">/demo/{demoSlug || ':slug'}</span>. This is mirrored on the Site Settings page.
              </p>
              <Select
                ...
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    {demoSlug && row.key !== 'landing' ? (
                      <a
                        href={`/demo/${demoSlug}?previewResult=${row.previewParam}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-xs text-primary hover:underline truncate font-mono block"
                      >
                        {origin}/demo/{demoSlug}?previewResult={row.previewParam}
                      </a>
                    ) : (
